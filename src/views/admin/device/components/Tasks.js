...
export default function ElectricityUsageTasks(props) {
  const { ...rest } = props;
  ...
  return (
    <Card p='20px' align='center' direction='column' w='100%' {...rest}>
      ...
      <Box px='11px'>
        ...
        <Flex mb='20px'>
          <Checkbox defaultChecked colorScheme='brandScheme' />
          <Text
            fontWeight='bold'
            color={textColor}
            fontSize='md'
            textAlign='start'>
            Track Electric Energy Consumption
          </Text>
          <Icon
            ms='auto'
            as={MdDragIndicator}
